  ...
  return (
    <DashboardLayout>
      <div className="mb-12 animate-fadeInUp">
        ...
        <p className="mt-3 text-sm" style={{ color: "#888" }}>Meta Ads, Google Ads, YouTube Ads et autres regies.</p>
      </div>
      ...
      {loading && (
        <div className="card p-14 text-center mt-10 animate-fadeIn">
          ...
          <p className="text-sm" style={{ color: "#888" }}>L'IA evalue votre publicite.</p>
        </div>
      )}
