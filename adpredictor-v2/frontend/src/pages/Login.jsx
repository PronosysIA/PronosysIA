      ...
      <div style={{ width: "100%", maxWidth: "380px", margin: "auto", padding: "40px 24px", position: "relative", zIndex: 1 }} className="animate-fadeInUp">
        ...
        <div style={{ marginBottom: "32px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px" }}>
            ...
            <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#333" }}>{t("login_badge")}</span>
          </div>
          <h1 style={{ fontFamily: "var(--font-display)", fontSize: "32px", fontStyle: "italic", color: "white", letterSpacing: "-0.02em", lineHeight: 1.1 }}>
            {t("login_heading")}
          </h1>
          <p style={{ marginTop: "8px", fontSize: "13px", color: "#333" }}>{t("login_subtitle")}</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: "18px" }}>
            <label style={{ display: "block", fontSize: "10px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#2A2A2A", marginBottom: "8px" }}>{t("login_email")}</label>
          ...
          <div style={{ marginBottom: "28px" }}>
            <label style={{ display: "block", fontSize: "10px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#2A2A2A", marginBottom: "8px" }}>{t("login_password")}</label>
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required placeholder={t("auth_password_dots")} className="input-dark" />
          </div>
          ...
          <button type="submit" disabled={loading} style={{ width: "100%", padding: "13px", background: loading ? "#1A1A1A" : "white", color: "#090909", fontWeight: 700, fontSize: "14px", borderRadius: "9px", border: "none", cursor: loading ? "not-allowed" : "pointer", transition: "all 0.2s ease", letterSpacing: "-0.01em" }}>
            {loading ? t("common_loading") : t("login_btn")}
          </button>
        </form>
