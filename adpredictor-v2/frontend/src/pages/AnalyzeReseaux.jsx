  ...
  return (
    <DashboardLayout>
      <div className="mb-12 animate-fadeInUp">
        <Link to="/dashboard" className="text-sm mb-6 inline-block transition-colors" style={{ color: "#888" }}>← Dashboard</Link>
        <h1 className="font-display text-3xl italic text-white">Videos Reseaux.</h1>
        <p className="mt-3 text-sm" style={{ color: "#888" }}>TikTok, Instagram Reels, YouTube Shorts, Snapchat.</p>
      </div>
      ...
      {loading && (
        <div className="card p-14 text-center mt-10 animate-fadeIn">
          ...
          <p className="text-sm" style={{ color: "#888" }}>L'IA decode les codes de viralite.</p>
        </div>
      )}
