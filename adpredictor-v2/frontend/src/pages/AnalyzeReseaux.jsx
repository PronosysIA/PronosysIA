  ...
  return (
    <DashboardLayout>
      <div className="mb-12 animate-fadeInUp">
        ...
        <p className="mt-3 text-sm" style={{ color: "#555" }}>TikTok, Instagram Reels, YouTube Shorts, Snapchat.</p>
      </div>
      ...
      {loading && (
        <div className="card p-14 text-center mt-10 animate-fadeIn">
          ...
          <p className="text-sm" style={{ color: "#555" }}>L'IA decode les codes de viralite.</p>
        </div>
      )}
